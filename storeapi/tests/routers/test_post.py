...
# they will use the fixture to test when the post is already created!
@pytest.fixture()  # it will look for conftest.py in this folder, not found, goes to parent and found
